...
<email:smtp-config name="Email_SMTP" doc:name="Email SMTP">
    <email:smtp-connection host="smtp.gmail.com" port="587" user="your-email@gmail.com" password="your-16-char-app-password">
        <email:properties>
...
```
* Deploy frontend to **Netlify** connected to GitHub.
* Frontend code updates automatically on every `git push` without requiring any MuleSoft `.jar` redeployment!
* MuleSoft CloudHub API runs 24/7 in the cloud independent of the local computer.
